...
$classes = ($active ?? false)
            ? 'inline-flex items-center border-b-2 border-cyan-600 px-1 pt-1 text-sm font-semibold leading-5 text-slate-950 transition duration-150 ease-in-out focus:outline-none focus:border-cyan-700'
